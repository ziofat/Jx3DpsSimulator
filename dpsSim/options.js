var whOptions = {
	1:[
		{name:"烟霞",desc:"“阳明指”的会心几率提高10%，会心效果提高10%。",skill:"阳明指",icon:4219,firstChild:true,active:false},
		{name:"弹指",desc:"“快雪时晴”的会心几率提高10%，会心效果提高10%。",skill:"快雪时晴",icon:4564,firstChild:true,active:false},
		{name:"少阳指",desc:"少阳指",skill:"少阳指",icon:1517,firstChild:true,active:false}
	],
	2:[
		{name:"寒碧",desc:"若目标身上没有“钟林毓秀”效果，则阳明指附带“钟林毓秀”，该效果每12秒触发一次。",skill:"阳明指",icon:408,firstChild:false,active:false},
		{name:"寒血",desc:"“施展“商阳指”立刻造成伤害",skill:"商阳指",icon:1514,firstChild:false,active:false},
		{name:"花语酥心",desc:"花语酥心",skill:"花语酥心",icon:407,firstChild:false,active:false}
	],
	3:[
		{name:"青歌",desc:"“快雪时晴”每0.6秒造成一次伤害，持续3秒。",skill:"快雪时晴",icon:2999,firstChild:false,active:false},
		{name:"风烟翠",desc:"“阳明指”命中附带自身持续伤害效果的目标，可将该效果添加给目标半径8尺内的最多5个目标",skill:"阳明指",icon:3016,firstChild:false,active:false},
		{name:"倚天",desc:"“钟林毓秀”每跳降低玩家目标1%内力，并回复自身1%内力。",skill:"钟林毓秀",icon:404,firstChild:false,active:false},
		{name:"清风垂露",desc:"清风垂露",skill:"清风垂露",icon:1523,firstChild:false,active:false}
	],
	4:[
		{name:"束发",desc:"“快雪时晴”作用目标增加3个。",skill:"快雪时晴",icon:4573,firstChild:false,active:false},
		{name:"列宿",desc:"运功不会被打退。",skill:"",icon:3015,firstChild:false,active:false},
		{name:"潜催",desc:"“玉石俱焚”可以吞噬目标半径8尺内额外5个目标身上属于自身的持续伤害。",skill:"玉石俱焚",icon:3012,firstChild:false,active:false},
	...
	9:[
		{name:"生息",desc:"混元性持续伤害提高10%，持续伤害效果被卸除后，每个持续伤害使目标1.5秒内无法受到治疗效果，最多叠加4.5秒。",skill:"",icon:3016,firstChild:false,active:false},
		{name:"流离",desc:"“玉石俱焚”命中目标后使自身下一个“兰摧玉折”无需运功",skill:"玉石俱焚",icon:3002,firstChild:false,active:false},
		{name:"金针",desc:"“毫针”每层的回复效果提高到6%，受到攻击消耗掉所有层数后，定身周围6尺的5个目标。",skill:"毫针",icon:1521,firstChild:false,active:false},
